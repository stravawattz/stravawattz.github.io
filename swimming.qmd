...
list(
  color = "info",
  value = paste0(round(sum((df_all_distinct %>% filter(type == "Swim" & year(date) == 2025) %>% select(distance)), na.rm = TRUE) / 1000, 0), " km")
)
```
...
list(
  color = "info",
  value = paste0(round(sum((df_all_distinct %>% filter(type == "Swim" & year(date) == 2024) %>% select(distance)), na.rm = TRUE) / 1000, 0), " km")
)
```
...
list(
  color = "info",
  value = paste0(round(sum((df_all_distinct %>% filter(type == "Swim" & year(date) == 2023) %>% select(distance)), na.rm = TRUE) / 1000, 0), " km")
)
```
